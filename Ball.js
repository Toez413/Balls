...
Object.defineProperty(Ball.prototype, "color", {
    get: function () {
        if (this.sprite == sprites.redBall) return Color.red;
        if (this.sprite == sprites.yellowBall) return Color.yellow;
        if (this.sprite == sprites.blackBall) return Color.black;
        return Color.white;
    },
    set: function (value) {
        if (value === Color.red) this.sprite = sprites.redBall;
        else if (value == Color.yellow) this.sprite = sprites.yellowBall;
        else if (value == Color.black) this.sprite = sprites.blackBall;
        else this.sprite = sprites.ball;
    }
});
...
function calculateBallVelocity(power, angle) {
